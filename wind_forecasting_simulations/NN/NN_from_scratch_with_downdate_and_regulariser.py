...
if __name__ == "__main__":
    ...
    regulariser = 0.0012 #9e-10 * (prediction_horizon ** 3.823)
    max_num_measures = 1900 #int(3900 *np.exp(-0.04 * prediction_horizon) + 1100)
    # print(f'regulariser: {regulariser}')
    # print(f'max_num_measures: {max_num_measures}')
