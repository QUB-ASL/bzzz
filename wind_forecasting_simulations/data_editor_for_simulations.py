...
def DataEditor(file_name):
    ...
    res['Wind_Speed'] = df_wind.wind_speed.values
    res['Wind_Speed_2D'] = df_wind.wind_speed_2D.values
    res['H_direction'] = df_wind.H_direction.values
    res['V_direction'] = df_wind.V_direction.values
    res['U_axis'] = df_wind.U_axis.values
    res['V_axis'] = df_wind.V_axis.values
    res['W_axis'] = df_wind.W_axis.values
