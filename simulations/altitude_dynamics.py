...
class AltitudeDynamics:
    ...
    def __init__(self,
        ...
        :param sampling_time: Sampling time of the discrete time system in seconds, 
            defaults to 0.01.
        :param z0: Initial altitude of the quad-rotor in meters, defaults to 0.
        :param vz_0: Initial velocity along global z-axis of the quad-rotor in m/s, 
            defaults to 0.
        :param az_0: Initial accleration along global z-axis of the quad-rotor 
            in m/s^2, defaults to 0.
        :param alpha: constant of multipilcation to convert reference thrust into 
            accleration in Kg^-1, defaults to 1.
        :param c: Any constant accleration on the drone along the global z-axis 
            (like accleration due to gravity), defaults to -9.81.
        """
    ...
    def __dynamics(self, z_t: float, vz_t: float, Tref_t: float):
        ...
        :param Tref_t: Reference thrust/ thrust produced by the quad-rotor 
            along the global z-axis, current thrust.
    ...
    def simulate(self, Tref_t: float):
        ...
        :param Tref_t: Reference thrust/ thrust produced by the quad-rotor along 
            the global z-axis, current thrust.
        """
        z_t_1, vz_t_1, az_t = self.__dynamics(
            z_t=self.z[-1], vz_t=self.vz[-1], Tref_t=Tref_t)
        self.z.append(z_t_1)
