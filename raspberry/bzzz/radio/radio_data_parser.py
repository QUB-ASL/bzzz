...
class RadioDataParser:
    ...
    def yaw_rate_reference_rad_sec(self):
        ...
        """
        self.yawRatePercentage = self.__map_trimmer_to_percentage(self.m_channelData[RADIO_CHANNEL_YAW_RATE])
        return -RADIO_MAX_YAW_RATE_RAD_SEC + 2 * RADIO_MAX_YAW_RATE_RAD_SEC * self.yawRatePercentage
