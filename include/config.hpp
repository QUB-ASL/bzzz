 ...
 * AHRS config
 */
#define MAGNETOMETER_BIAS_X 78.343
#define MAGNETOMETER_BIAS_Y 411.764
#define MAGNETOMETER_BIAS_Z -488.971

#define MAGNETOMETER_SCALE_X 0.963
#define MAGNETOMETER_SCALE_Y 1.051
#define MAGNETOMETER_SCALE_Z 0.990
